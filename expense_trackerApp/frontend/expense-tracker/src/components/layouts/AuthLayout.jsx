  ...
  return (
    <div className='flex'>
      ...
      <div className='w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12'>
        <h2 className='text-2xl font-medium text-black'>Expense <span className='text-5xl text-violet-600'>T</span>racker<span className='text-4xl text-violet-600'>.</span></h2>
        {children}
      </div>
      ...
      <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
        ...
        <img
          src={CARD_2}
          className='w-64 lg:w-[90%] rounded-[22px] absolute bottom-10 shadow-lg shadow-blue-400/15'
        />
      </div>
